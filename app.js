const WORDS = [
  ...
  {w:"prescient",p:"adj.",m:"선견지명이 있는, 예지하는",e:"The prescient decision to invest in technology positioned the firm ahead of competitors.",et:"기술에 투자하기로 한 선견지명 있는 결정이 회사를 경쟁사보다 앞서게 했다."},{w:"exigency",p:"n.",m:"급박함, 긴급한 필요",e:"The exigency of the situation demanded immediate executive decision-making.",et:"상황의 긴급함은 즉각적인 경영진 의사결정을 요구했다."},{w:"quixotic",p:"adj.",m:"몽상적인, 현실적이지 않은",e:"The quixotic expansion plan ignored realistic market constraints.",et:"그 몽상적인 확장 계획은 현실적인 시장 제약을 무시했다."},{w:"obfuscation",p:"n.",m:"혼란 야기, 불명확함",e:"The financial report's obfuscation made it difficult for investors to understand the company's true performance.",et:"그 재무 보고서의 불명확함은 투자자들이 회사의 실제 성과를 이해하기 어렵게 만들었다."},{w:"extraneous",p:"adj.",m:"외부의, 무관한",e:"Remove all extraneous information from the proposal to make it more concise and impactful.",et:"제안서에서 모든 무관한 정보를 제거하여 더욱 간결하고 영향력 있게 만들어라."},{w:"endue",p:"v.",m:"부여하다, 입혀지다",e:"The new leadership structure is endued with greater authority and accountability.",et:"새로운 지도 체계는 더 큰 권한과 책임이 부여되었다."},{w:"pellate",p:"adj.",m:"투명한, 명확한",e:"The company provided pellate explanations regarding the changes in company policy.",et:"회사는 회사 정책의 변화에 대해 명확한 설명을 제공했다."},{w:"tendril",p:"n.",m:"덩굴손, 나선형 구조",e:"The organization has business tendrils extending into multiple market segments.",et:"그 조직은 여러 시장 부분으로 뻗어나가는 사업 네트워크를 가지고 있다."},{w:"facile",p:"adj.",m:"쉬운, 얕은",e:"The team rejected the facile solution in favor of a more comprehensive approach.",et:"팀은 얕은 해결책을 거부하고 더 포괄적인 접근을 선택했다."},{w:"pellatory",p:"adj.",m:"미루는, 지연하는",e:"The client's pellatory tactics delayed the project by several months.",et:"고객의 지연 전술은 프로젝트를 수개월 미루었다."},
  {w:"propinquitous",p:"adj.",m:"가까운, 근접한",e:"The propinquitous relationship between the two companies facilitated collaboration.",et:"두 회사의 가까운 관계는 협업을 용이하게 했다."},{w:"nugacious",p:"adj.",m:"하찮은, 무의미한",e:"The manager dismissed the nugacious complaints and focused on critical issues.",et:"관리자는 하찮은 불만을 무시하고 중요한 문제에 집중했다."},{w:"pellicle",p:"n.",m:"얇은 막, 표피",e:"The pellicle of trust was damaged by the company's misleading statement.",et:"회사의 허위 진술로 신뢰의 얇은 막이 손상되었다."},{w:"pellation",p:"n.",m:"명확화, 투명성",e:"The pellation of the company's financial position reassured stakeholders.",et:"회사의 재무 상태의 명확화는 이해관계자들을 안심시켰다."},{w:"belabor",p:"v.",m:"과도하게 강조하다, 자세히 설명하다",e:"The presenter belabored the point about cost reduction throughout the meeting.",et:"발표자는 회의 내내 비용 절감에 대한 요점을 과도하게 강조했다."},{w:"beleaguer",p:"v.",m:"괴롭히다, 곤경에 처하게 하다",e:"The company was beleaguered by multiple regulatory investigations last year.",et:"그 회사는 지난해 여러 규제 조사로 인해 곤경에 처했다."},{w:"bereft",p:"adj.",m:"~을 잃은, 결핍된",e:"The division was bereft of experienced staff after the layoffs.",et:"감원 후 그 부서는 경험 있는 직원들이 부족했다."},{w:"berate",p:"v.",m:"심하게 꾸짖다, 질책하다",e:"The supervisor berated the team for missing the project deadline.",et:"감독자는 팀이 프로젝트 마감일을 놓친 것에 대해 질책했다."},{w:"besotted",p:"adj.",m:"~에 홀린, 취한",e:"The client seemed besotted with the new product features.",et:"그 클라이언트는 새로운 제품 기능에 홀려 있는 것 같았다."},{w:"bifurcation",p:"n.",m:"분기, 두 갈래로 나뉨",e:"The bifurcation of the company led to two independent business units.",et:"회사의 분기는 두 개의 독립적인 사업부로 이어졌다."},
  {w:"bromide",p:"n.",m:"진부한 표현, 상투적 진술",e:"The motivational speech was full of tired bromides about teamwork.",et:"그 동기 부여 연설은 팀워크에 관한 진부한 표현으로 가득 찼다."},{w:"callous",p:"adj.",m:"무감각한, 냉정한",e:"Management's callous attitude toward employee concerns damaged morale.",et:"경영진의 직원 우려에 대한 무감각한 태도는 사기를 떨어뜨렸다."},{w:"calumny",p:"n.",m:"명예훼손, 모욕",e:"The executive denied the calumny spread by competitors in the industry.",et:"그 임원은 업계 경쟁자들이 퍼뜨린 명예훼손을 부인했다."},{w:"cataclysm",p:"n.",m:"격변, 대변동",e:"The merger created a cataclysm in the corporate structure.",et:"그 합병은 회사 구조에 격변을 일으켰다."},{w:"catalyst",p:"n.",m:"촉매, 계기",e:"The new technology served as a catalyst for business growth.",et:"새로운 기술은 사업 성장의 촉매 역할을 했다."},{w:"categorical",p:"adj.",m:"명확한, 절대적인",e:"The manager gave a categorical refusal to the proposal.",et:"그 관리자는 그 제안에 명확히 거절했다."},{w:"caustic",p:"adj.",m:"신랄한, 부식성의",e:"His caustic comments about the project undermined team confidence.",et:"그의 프로젝트에 대한 신랄한 댓글은 팀의 신뢰를 훼손했다."},{w:"celerity",p:"n.",m:"빠른 속도, 신속성",e:"We completed the transaction with remarkable celerity.",et:"우리는 놀라운 신속성으로 거래를 완료했다."},{w:"censorious",p:"adj.",m:"비판적인, 쓸데없이 비난하는",e:"The board took a censorious view of management's financial decisions.",et:"그 이사회는 경영진의 재무 결정을 비판적으로 봤다."},{w:"centrifugal",p:"adj.",m:"중심에서 벗어나는, 원심의",e:"Centrifugal forces within the organization threatened its unity.",et:"조직 내의 원심력은 그것의 통일성을 위협했다."},
  {w:"cession",p:"n.",m:"양도, 이양",e:"The cession of the territory was formalized in the contract.",et:"그 영토의 양도는 계약으로 공식화되었다."},{w:"chary",p:"adj.",m:"조심스러운, 의심하는",e:"Investors were chary of the startup's unproven business model.",et:"투자자들은 그 스타트업의 입증되지 않은 사업 모델을 의심했다."},{w:"chicanery",p:"n.",m:"속임수, 부정 행위",e:"The auditor discovered financial chicanery in the subsidiary accounts.",et:"감사원은 자회사 계정에서 재무 부정 행위를 발견했다."},{w:"coalesce",p:"v.",m:"합쳐지다, 연합하다",e:"The separate departments coalesced into one unified division.",et:"개별 부서들이 하나의 통일된 부서로 합쳐졌다."},{w:"perspicuously",p:"adv.",m:"명확하게, 분명히",e:"The executive perspicuously outlined the company's strategic direction.",et:"경영진은 회사의 전략적 방향을 명확하게 설명했다."},{w:"assiduously",p:"adv.",m:"부지런하게, 꾸준하게",e:"The team assiduously worked to meet the quarterly targets.",et:"팀은 분기별 목표를 달성하기 위해 꾸준히 노력했다."},{w:"pecuniary",p:"adj.",m:"금전의, 금전적인",e:"The contract specifies pecuniary penalties for non-compliance breaches.",et:"계약서는 미준수에 대한 금전적 페널티를 명시한다."},{w:"obloquy",p:"n.",m:"비난, 욕설",e:"The executive faced severe obloquy after the scandal was revealed to the public.",et:"그 임원은 스캔들이 공개된 후 심한 비난을 받았다."},{w:"contumacy",p:"n.",m:"완강함, 반항",e:"The employee's contumacy toward company policies resulted in immediate termination.",et:"그 직원의 회사 정책에 대한 완강한 반항으로 즉시 해고되었다."},{w:"acclimate",p:"v.",m:"적응하다",e:"New employees need time to acclimate to the company culture.",et:"신입사원들은 회사 문화에 적응할 시간이 필요하다."},
  {w:"acquiesce",p:"v.",m:"동의하다, 승낙하다",e:"The board acquiesced to the proposal despite initial reservations.",et:"이사회는 초기 우려에도 불구하고 제안에 동의했다."},{w:"adamant",p:"adj.",m:"완강한, 단호한",e:"Management remained adamant about implementing the new policy.",et:"경영진은 새로운 정책 시행에 대해 단호한 태도를 유지했다."},{w:"adjudicate",p:"v.",m:"판정하다, 중재하다",e:"An independent arbitrator will adjudicate the dispute between the two parties.",et:"독립적인 중재자가 두 당사자 간의 분쟁을 판정할 것이다."},{w:"admonish",p:"v.",m:"경고하다, 훈계하다",e:"The supervisor admonished the employee for repeated tardiness.",et:"감독자는 반복된 지각으로 직원을 훈계했다."},{w:"adulteration",p:"n.",m:"성분 혼입, 위조",e:"The company faced penalties for adulteration of their product.",et:"회사는 제품 위조로 인해 벌칙을 받았다."},{w:"affidavit",p:"n.",m:"선서 진술서",e:"The witness submitted an affidavit detailing the incident.",et:"증인은 사건을 상세히 기술한 선서 진술서를 제출했다."},{w:"aggrandize",p:"v.",m:"과장하다, 부풀리다",e:"The executive aggrandized his accomplishments in the annual report.",et:"임원은 연간 보고서에서 자신의 성과를 과장했다."},{w:"agile",p:"adj.",m:"민첩한, 재빠른",e:"The company adopted an agile approach to project management.",et:"회사는 프로젝트 관리에 민첩한 접근 방식을 채택했다."},{w:"agonize",p:"v.",m:"고민하다, 괴로워하다",e:"The board agonized over the decision to downsize the workforce.",et:"이사회는 인력 감축 결정으로 고민했다."},{w:"algorithm",p:"n.",m:"알고리즘",e:"The new algorithm significantly improved processing efficiency.",et:"새로운 알고리즘은 처리 효율을 크게 개선했다."},
  {w:"alleviate",p:"v.",m:"완화하다, 덜어주다",e:"The new software alleviates the administrative burden on staff.",et:"새로운 소프트웨어는 직원의 행정 부담을 완화한다."},{w:"allocation",p:"n.",m:"배분, 할당",e:"The allocation of resources requires careful planning and oversight.",et:"자원의 배분은 신중한 계획과 감독이 필요하다."},{w:"ambidextrous",p:"adj.",m:"양손잡이의, 다재다능한",e:"The consultant is ambidextrous in both technical and business skills.",et:"그 컨설턴트는 기술 및 사업 기술에 있어 다재다능하다."},{w:"anachronistic",p:"adj.",m:"시대에 뒤떨어진",e:"The company's outdated systems are increasingly anachronistic.",et:"회사의 구식 시스템은 점점 더 시대에 뒤떨어져 있다."},{w:"apex",p:"n.",m:"정점, 최고점",e:"The company reached the apex of its market success last quarter.",et:"회사는 지난 분기에 시장 성공의 정점에 도달했다."},{w:"appraise",p:"v.",m:"평가하다, 감정하다",e:"HR will appraise employee performance during the review cycle.",et:"인사팀은 검토 주기 중에 직원 성과를 평가할 것이다."},{w:"apt",p:"adj.",m:"적절한, 경향이 있는",e:"The proposal is apt to face resistance from the stakeholders.",et:"그 제안은 이해관계자로부터 저항을 받을 가능성이 높다."},{w:"arduous",p:"adj.",m:"힘든, 험난한",e:"The merger process proved to be an arduous undertaking for both firms.",et:"인수 합병 과정은 두 회사 모두에게 힘든 작업으로 판명되었다."},{w:"prudent",p:"adj.",m:"신중한, 분별 있는",e:"The company made a prudent decision to diversify its investment portfolio.",et:"그 회사는 투자 포트폴리오를 다양화하는 신중한 결정을 내렸다."},{w:"paramount",p:"adj.",m:"최고의, 가장 중요한",e:"Customer satisfaction is paramount to our business strategy.",et:"고객 만족은 우리 사업 전략에서 가장 중요하다."},
  {w:"impeccable",p:"adj.",m:"흠잡을 데 없는, 완벽한",e:"The auditors found the financial records impeccable and well-documented.",et:"감사인들은 재무 기록이 흠잡을 데 없고 잘 기록되어 있음을 발견했다."},{w:"substantive",p:"adj.",m:"실질적인, 중요한",e:"The committee made substantive changes to the project proposal.",et:"위원회는 프로젝트 제안에 실질적인 변경을 가했다."},{w:"truncate",p:"v.",m:"자르다, 줄이다",e:"The system automatically truncates files exceeding the storage limit.",et:"시스템은 저장 용량을 초과하는 파일을 자동으로 삭제한다."},{w:"ossified",p:"adj.",m:"경화된, 경직된",e:"The organization's ossified procedures hindered innovation and growth.",et:"그 조직의 경직된 절차는 혁신과 성장을 방해했다."},{w:"attenuate",p:"v.",m:"약화시키다, 감소시키다",e:"Market volatility will attenuate once the new regulations take effect.",et:"새로운 규정이 시행되면 시장 변동성이 약화될 것이다."},{w:"remuneration",p:"n.",m:"보수, 급료",e:"The company offers competitive remuneration and comprehensive benefits.",et:"그 회사는 경쟁력 있는 보수와 포괄적인 복리후생을 제공한다."},{w:"quandary",p:"n.",m:"곤경, 딜레마",e:"The finance department faced a quandary regarding budget allocation.",et:"재무부는 예산 배분에 관한 딜레마에 직면했다."},{w:"nexus",p:"n.",m:"연결, 고리",e:"The nexus between marketing and sales strategy proved crucial for success.",et:"마케팅과 판매 전략의 연결이 성공에 결정적이었다."},{w:"draconian",p:"adj.",m:"가혹한, 혹독한",e:"The company's draconian cost-cutting measures damaged employee morale.",et:"그 회사의 가혹한 비용 절감 조치는 직원 사기를 떨어뜨렸다."},{w:"erudite",p:"adj.",m:"박식한, 학식 있는",e:"The consultant's erudite analysis impressed the board of directors.",et:"그 컨설턴트의 박식한 분석은 이사회를 감동시켰다."},
  {w:"sycophantic",p:"adj.",m:"아첨하는, 기꺼이 종속하는",e:"The manager avoided sycophantic behavior and provided honest feedback.",et:"그 매니저는 아첨하는 태도를 피하고 솔직한 피드백을 제공했다."},{w:"bellicose",p:"adj.",m:"호전적인, 싸움을 좋아하는",e:"The two departments' bellicose negotiations delayed the merger process.",et:"두 부서의 호전적인 협상은 인수합병 과정을 지연시켰다."},{w:"acrimonious",p:"adj.",m:"신랄한, 쓸쓸한",e:"The acrimonious dispute between the two companies delayed the merger negotiations.",et:"두 회사 간의 신랄한 분쟁이 인수합병 협상을 지연시켰다."},{w:"covet",p:"v.",m:"탐내다, 간절히 원하다",e:"Many employees covet the promotion opportunity that was recently announced.",et:"많은 직원들이 최근에 공고된 승진 기회를 간절히 원한다."},{w:"demur",p:"v.",m:"이의를 제기하다, 반대하다",e:"The CFO did not demur at the proposal for increased research and development spending.",et:"CFO는 연구개발 지출 증가 제안에 이의를 제기하지 않았다."},{w:"rarefied",p:"adj.",m:"희박한, 고급스러운",e:"Only a rarefied group of executives had access to the confidential strategic plans.",et:"소수의 고위 경영진들만 기밀 전략 계획에 접근할 수 있었다."},{w:"redress",p:"v.",m:"시정하다, 보상하다",e:"The company took immediate action to redress the accounting errors discovered last quarter.",et:"회사는 지난 분기에 발견된 회계 오류를 시정하기 위해 즉시 조치를 취했다."},{w:"stringent",p:"adj.",m:"엄격한, 까다로운",e:"The new compliance requirements are quite stringent and require significant departmental changes.",et:"새로운 준수 요구사항은 매우 엄격하며 상당한 부서 변화를 필요로 한다."},{w:"ternary",p:"adj.",m:"3배의, 3원의",e:"The ternary structure of the organization improved communication between departments.",et:"조직의 3원 구조는 부서 간 소통을 개선했다."},{w:"turgid",p:"adj.",m:"부풀린, 과장된",e:"The report's turgid language made it difficult for stakeholders to understand key findings.",et:"보고서의 과장된 표현은 이해관계자들이 주요 결과를 이해하기 어렵게 했다."},
  {w:"unexceptionable",p:"adj.",m:"흠잡을 데 없는, 이의의 여지가 없는",e:"The new policy is unexceptionable and has been approved by all departments.",et:"새로운 정책은 흠잡을 데 없으며 모든 부서에서 승인했다."},{w:"ebullient",p:"adj.",m:"열정적인, 들떠 있는",e:"The newly promoted manager was ebullient about leading the team.",et:"새로 승진한 관리자는 팀을 이끌 생각에 열정적이었다."},{w:"vitigate",p:"v.",m:"손상시키다, 무효화하다",e:"False claims can vitiate the entire business agreement between parties.",et:"거짓 주장은 당사자 간의 전체 사업 계약을 무효화할 수 있다."},{w:"avuncular",p:"adj.",m:"삼촌 같은, 자상한",e:"The CEO took an avuncular approach to mentoring junior employees.",et:"그 CEO는 후배 직원들을 지도할 때 자상한 태도를 취했다."},{w:"nostrum",p:"n.",m:"특효약, 묘안",e:"Management presented a new nostrum to solve the operational inefficiency problem.",et:"경영진은 운영 비효율 문제를 해결하기 위한 새로운 묘안을 제시했다."},{w:"nadir",p:"n.",m:"최저점, 바닥",e:"The company's stock price hit its nadir during the economic recession.",et:"경제 침체 중에 그 회사의 주가는 최저점에 도달했다."},{w:"morass",p:"n.",m:"늪지, 곤경",e:"The project became mired in a morass of bureaucratic procedures.",et:"그 프로젝트는 관료적 절차의 늪에 빠졌다."},{w:"propugn",p:"v.",m:"반박하다, 맞서다",e:"The consultant propugned the proposed restructuring plan during the meeting.",et:"그 컨설턴트는 회의 중에 제안된 구조 조정 계획에 반박했다."},{w:"stricture",p:"n.",m:"비판, 제약",e:"The new regulations imposed strictures on financial transactions across borders.",et:"새로운 규정은 국경을 넘는 금융 거래에 제약을 가했다."},{w:"propugnation",p:"n.",m:"방어, 옹호",e:"The attorney's vigorous propugnation of the client's rights impressed the court.",et:"변호사의 의뢰인 권리에 대한 강력한 옹호가 법원을 감동시켰다."},
  {w:"propugnatory",p:"adj.",m:"옹호하는, 방어하는",e:"The company took a propugnatory stance against the acquisition attempt.",et:"회사는 인수 시도에 대해 방어적인 태도를 취했다."},{w:"propugnant",p:"adj.",m:"반박하는, 맞서는",e:"The propugnant evidence presented by the defense weakened the prosecution's case.",et:"변호인이 제시한 반박 증거는 검찰의 사건을 약화시켰다."},{w:"strictured",p:"adj.",m:"제약받는, 비판받는",e:"The strictured budget limited the department's ability to expand operations.",et:"제약받는 예산이 부서의 업무 확장 능력을 제한했다."},{w:"nugacity",p:"n.",m:"무가치함, 하찮음",e:"The nugacity of the proposal became apparent after the feasibility study.",et:"타당성 조사 후 제안의 하찮음이 명백해졌다."},{w:"propugnancy",p:"n.",m:"반박, 대항",e:"The propugnancy of the rival firm's argument required careful consideration.",et:"경쟁사의 주장에 대한 반박은 신중한 검토가 필요했다."},{w:"pelliculate",p:"adj.",m:"얇은 막이 있는",e:"The pelliculate coating protected the electronic components from moisture.",et:"얇은 막 코팅이 전자 부품을 습기로부터 보호했다."},{w:"strictural",p:"adj.",m:"구조적인, 제약적인",e:"The strictural changes to the organization improved efficiency significantly.",et:"조직의 구조적 변화가 효율성을 크게 개선했다."},{w:"nugatorial",p:"adj.",m:"무가치한, 무용지물의",e:"The committee deemed the suggestion nugatorial and moved forward with the plan.",et:"위원회는 그 제안을 무가치하다고 판단하고 계획을 진행했다."},{w:"convivial",p:"adj.",m:"친근한, 즐거운",e:"The team enjoyed a convivial atmosphere during the annual company retreat.",et:"팀은 연례 회사 리트릿 동안 친근한 분위기를 즐겼다."},{w:"obdurate",p:"adj.",m:"완고한, 고집스러운",e:"The obdurate client refused to negotiate the contract terms.",et:"완고한 고객은 계약 조건 협상을 거부했다."},
  {w:"reticent",p:"adj.",m:"말이 적은, 비밀스러운",e:"The CEO remained reticent about the company's future expansion plans.",et:"CEO는 회사의 향후 확장 계획에 대해 말을 아꼈다."},{w:"assimilate",p:"v.",m:"동화하다, 습득하다",e:"New employees need time to assimilate the company's corporate culture.",et:"신입 직원들은 회사 문화에 동화될 시간이 필요하다."},{w:"insolvency",p:"n.",m:"지불 불능, 파산 상태",e:"The financial audit revealed the firm's insolvency to the board.",et:"재무 감시는 회사의 지불 불능 상태를 이사회에 드러냈다."},{w:"ramification",p:"n.",m:"결과, 파급 효과",e:"The merger has significant ramifications for all stakeholders.",et:"이 합병은 모든 이해관계자에게 상당한 영향을 미친다."},{w:"fraught",p:"adj.",m:"위험으로 가득한, 많이 있는",e:"The market expansion strategy is fraught with potential challenges.",et:"시장 확장 전략은 잠재적 위험으로 가득 차 있다."},{w:"procrastinate",p:"v.",m:"미루다, 늦추다",e:"Managers should not procrastinate on critical decisions.",et:"관리자는 중요한 결정을 미루어서는 안 된다."},{w:"auspices",p:"n.",m:"후원, 지원, 영향",e:"Under the auspices of the board, the project proceeded smoothly.",et:"이사회의 후원 아래 프로젝트가 순조롭게 진행되었다."},{w:"delinquent",p:"adj.",m:"연체된, 태만한",e:"The client's delinquent payment caused cash flow problems.",et:"고객의 연체금은 현금 흐름 문제를 야기했다."},{w:"rectitude",p:"n.",m:"정직함, 올바름",e:"The CEO's rectitude earned the trust of investors.",et:"CEO의 정직함은 투자자의 신뢰를 얻었다."},{w:"plenitude",p:"n.",m:"충분함, 풍부함",e:"The plenitude of resources allowed rapid market expansion.",et:"풍부한 자원이 빠른 시장 확장을 가능하게 했다."},
  {w:"obtuse",p:"adj.",m:"둔한, 이해가 느린",e:"The client's obtuse response to feedback delayed the project implementation.",et:"그 고객의 피드백에 대한 둔한 반응이 프로젝트 구현을 지연시켰다."},{w:"remonstrate",p:"v.",m:"항의하다, 반박하다",e:"The employee remonstrated against the unfair compensation policy.",et:"직원은 부당한 보상 정책에 항의했다."},{w:"erstwhile",p:"adj.",m:"이전의, 과거의",e:"The company merged with its erstwhile competitor last year.",et:"그 회사는 지난해 이전의 경쟁사와 합병했다."},{w:"propound",p:"v.",m:"제안하다, 제시하다",e:"The consultant propounded a new strategy to improve efficiency.",et:"컨설턴트는 효율성을 높이기 위한 새로운 전략을 제시했다."},{w:"ensconce",p:"v.",m:"안전하게 자리잡히다",e:"The executive ensconced himself in the corner office.",et:"임원은 코너 사무실에 안전하게 자리를 잡았다."},{w:"apposite",p:"adj.",m:"적절한, 맞는",e:"His apposite remarks resolved the ongoing dispute quickly.",et:"그의 적절한 발언은 지속된 분쟁을 빠르게 해결했다."},{w:"repine",p:"v.",m:"불평하다, 한탄하다",e:"The staff began to repine about the delayed project completion.",et:"직원들은 지연된 프로젝트 완료에 불평하기 시작했다."},{w:"invidious",p:"adj.",m:"불쾌한, 차별적인",e:"The invidious comparison between employees created tension.",et:"직원 간의 불쾌한 비교는 긴장을 조성했다."},{w:"fustian",p:"n.",m:"거창한 말, 허튼소리",e:"The presentation was filled with marketing fustian and vague promises.",et:"그 발표는 거창한 마케팅 말과 모호한 약속으로 가득 찼다."},{w:"venal",p:"adj.",m:"뇌물 받을 수 있는, 부패한",e:"The venal official accepted bribes from contractors regularly.",et:"그 부패한 관리자는 정기적으로 계약자들로부터 뇌물을 받았다."},
  {w:"prolix",p:"adj.",m:"장황한, 말이 많은",e:"His prolix speech made the meeting extend far beyond schedule.",et:"그의 장황한 연설은 회의를 예정보다 훨씬 길게 했다."},{w:"blandish",p:"v.",m:"달콤한 말로 설득하다",e:"The salesman tried to blandish the client into signing.",et:"판매원은 고객을 달콤한 말로 서명하도록 설득하려 했다."},{w:"plenipotentiary",p:"n.",m:"전권 대사",e:"The plenipotentiary negotiated the international trade agreement.",et:"전권 대사는 국제 무역 협정을 협상했다."},{w:"obstinate",p:"adj.",m:"고집스러운, 완고한",e:"The obstinate client refused to consider alternative solutions.",et:"그 완고한 클라이언트는 다른 해결책을 고려하기를 거부했다."},{w:"offuscate",p:"v.",m:"모호하게 하다, 혼동시키다",e:"The complex jargon only offuscated the actual problem.",et:"복잡한 전문용어는 실제 문제만 모호하게 했다."},{w:"trenchant",p:"adj.",m:"예리한, 명확한",e:"Her trenchant critique improved the company's strategy.",et:"그녀의 예리한 비판은 회사의 전략을 개선했다."}
];
